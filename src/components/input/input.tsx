        ...
        <div className={clsx("relative", fullWidth && "w-full")}>
          <input
            ...
            className={clsx(
              ...
              !!rightIcon && "pr-8",
              !!leftIcon && "pl-10",
              label ? "pt-5 pb-[20px]" : "py-[19px]",
              status === "default" &&
                "border-gray-link focus-visible:border-primary",
              status === "error" &&
                "border-badge-product focus-visible:border-red-700",
              status === "success" &&
                "border-green-500 focus-visible:border-red-700",
